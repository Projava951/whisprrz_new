...
class CBanner extends CHtmlBlock
{
    ...
    static public function getBlock(&$html, $type, $prf = '')
	{
        ...
        if (strpos($type, 'admob') !== false) {
			$pageNoAdmobTmpl = array(
                //'edge' => array('index.php', 'join.php', 'about.php', 'info.php'),
                'urban_mobile' => array(/*'index.php', 'join.php', 'about.php', 'info.php', 'forgot_password.php',*/ 'messages.php',),
                'impact_mobile' => array(/*'index.php', 'join.php', 'about.php', 'info.php', 'forgot_password.php',*/ 'messages.php',),
            );
...
//            }
        ...
        $pos = $type;
        $block = 'banner_' . str_replace(array('_ios', '_android'), '', trim($type)) . $prf;
        $isParseBanner = false;
