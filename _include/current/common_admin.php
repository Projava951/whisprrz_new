...
class CAdminConfig extends CHtmlBlock
{
    ...
    private $notAvailableDateFormats = array(
        'urban' => array(
            'im_message_oryx_today',
            'im_message_oryx',
            'forum_message_created_at',
            'edit_event_date_mixer_js'
            ,
            'edit_hotdate_date_mixer_js',
            'edit_hotdate_time',
            'edit_hotdate_date',
            'hotdates_hotdate_time',
            'hotdates_hotdate_date',
            'blogs_searches_readable_datetime',
            'wall_hotdate_datetime',
            'hotdate_datetime',
            'hotdate_time',
            'hotdate_date',
            'edit_partyhou_date_mixer_js',
            'edit_partyhou_time',
            'edit_partyhou_date',
            'partyhouz_partyhou_time',
            'partyhouz_partyhou_date',
            'blogs_searches_readable_datetime',
            'wall_partyhou_datetime',
            'partyhou_datetime',
            'partyhou_time',
            'partyhou_date',
            'forum_topic_created_at',
            'forum_last_message_created_at',
            'flashchat_message_datetime',
            'blogs_comment_datetime',
            'blogs_comment_datetime_this_year',
            'blogs_list_date',
            'blogs_list_datetime',
            'blogs_datetime',
            'blogs_datetime_this_year',
            'vids_dt_time',
            'vids_dt_readable',
            'vids_comment',
            'edit_event_time',
            ...
            'blogs_searches_readable_datetime',
            'wall_event_datetime',
            'users_last_visit_date',
            'places_review_date',
            'event_datetime',
            'event_time',
            'event_date',
            'adv_date',
            'mobile_mail_datetime',
            'mobile_mail_datetime_today',
            'common_item_date_format_year',
            'common_item_date_format',
            'mail_date_sent',
            'mailtext_date_sent',
