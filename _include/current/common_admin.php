...
//        look_message_im.php look_message_chat.php look_message_mail.php
        ...
        if ($html->blockExists('data_smenu')) {
            $datesMenu = array(
                ...
                'dt_modules'  => array('spartner', 'sblogs', 'splaces', 'sflashchat', 's3dchat',
...
class CAdminConfig extends CHtmlBlock {
    ...
    private $notAvailableDateFormats = array(
        'urban' =>  array('im_message_oryx_today','im_message_oryx','forum_message_created_at','edit_event_date_mixer_js' 
                       ,'edit_hotdate_date_mixer_js','edit_hotdate_time', 'edit_hotdate_date', 
                        'hotdates_hotdate_time', 'hotdates_hotdate_date', 
                        'blogs_searches_readable_datetime', 'wall_hotdate_datetime',
                        'hotdate_datetime', 'hotdate_time', 'hotdate_date',
                        'edit_partyhou_date_mixer_js','edit_partyhou_time', 'edit_partyhou_date', 
                        'partyhouz_partyhou_time', 'partyhouz_partyhou_date', 
                        'blogs_searches_readable_datetime', 'wall_partyhou_datetime',
                        'partyhou_datetime', 'partyhou_time', 'partyhou_date',
