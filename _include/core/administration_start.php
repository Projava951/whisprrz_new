        ...
        if($name != "admin"){
            $admin_urls = array(
                ...
                "Media" => array(
                    ...
                    "vids_users.php", "vids_videos.php", "vids_comments.php", "vids_categories.php", "vids_category_add.php"
                ), 
                "SMS_TEXT" => array(
                    "sms_carriers.php", "autosms.php", "masssms.php"
                ),
                "PartyHouZ" => array(
                    "partyhouz_partyhouz.php", "partyhouz_partyhou_comments.php", "partyhouz_categories.php", "partyhouz_category_add.php"
                ), 
                "Home" => array(
                    "home_.php"
                ), 
