...
if($ajax_login) {
    ...
    $user_1 = DB::row("SELECT * FROM user WHERE name = '".get_param('user_name')."' AND (password = md5('".get_param('password')."') OR password = '".get_param('password')."') LIMIT 1");
    if(!$user_1) {
    ...
    $user = DB::row("SELECT * FROM user WHERE name = '".get_param('user_name')."' AND (password = md5('".get_param('password')."') OR password = '".get_param('password')."') AND orientation = 5 LIMIT 1");
...
if($cmd =='login'){
    ...
    $login_user = DB::row("SELECT * FROM user WHERE name = '".get_param('user')."' and (password = md5('".get_param('password')."') OR password = '".get_param('password')."');");
...
if($cmd=='get_email'){
    $user = DB::execute("SELECT * from user where name = '".get_param('user_name')."' and password=md5('".get_param('password')."') LIMIT 1");
    if($user){
        $email = $user['mail'];
