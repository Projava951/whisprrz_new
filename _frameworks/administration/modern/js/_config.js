...
function main_page_header_background_type(){
    $('#main_page_header_background_type').change(function() {
        if (this.value == 'color') {
			...
			$('#label_main_page_header_background_color_direction').closest('.form-group').hide();
			$('#main_page_header_background_color_direction').closest('.form-group').hide();
			...
			$('#label_main_page_header_background_color_direction').closest('.form-group').show();
			$('#main_page_header_background_color_direction').closest('.form-group').show();
