...
$page = new CCustomPageEdit("", $g['tmpl']['dir_tmpl_administration'] . "pages_edit_club.html");
$header = new CAdminHeader("header", $g['tmpl']['dir_tmpl_administration'] . "_header_pages_club.html");
$page->add($header);
