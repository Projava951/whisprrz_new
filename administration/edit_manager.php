...
class CEditManager extends CHtmlBlock
{
	...
	function parseBlock(&$html)
	{
        ...
        $fields = array(
            ...
            "SMS_TEXT" => l('menu_sms_text'), "PartyHouZ" => l('menu_partyhouz'), "Options" => l('menu_city_options'), "Statistics" => l('menu_stats'), "Payment" => l("menu_payment"), "Donation" => l('menu_donation'), "New_Page" => l('menu_club_add'),
