 ...
 */
            ...
            if ($v == "del") {
                ...
                if ($cmd == 'vids_video') {
                    ...
                    DB::query($sql, 2);
                    if ($row = DB::fetch_row(2)) {
						$comment = get_param_array('comment_video');
                ...
                if ($cmd == 'photo') {
                    ...
                    if ($row = DB::fetch_row(2)) {
						...
						$comment = get_param_array('comment_photo');
    ...
    function parseBlock(&$html)
    {
        ...
        if ($cmd == 'texts') {
            ...
            while ($row = DB::fetch_row(2)) {
                ...
                $html->setvar("photo_file", trim(str_replace('photo/', '', CProfilePhoto::createBasePhotoFilePath($row['user_id'], $row['photo_id'], $row['hash'], false)), '_'));
